...
const { fetchAll } = require('../services/megasena');

const OUTPUT_FILE = path.resolve(__dirname, '../../data/megasena-resultados.json');

async function main() {
  console.log('Iniciando download de todos os resultados da Mega-Sena...');
